...
export const metadata: Metadata = {
  title: "About Yoocal — Your local, everywhere.",
  description:
    "Yoocal is one place for everything happening in your city — for locals and visitors alike. Updated daily from every source that matters.",
  alternates: { canonical: "https://www.yoocal.com/about" },
  openGraph: {
    title: "About Yoocal — Your local, everywhere.",
    description:
      "One place for everything happening in your city. Free, updated daily.",
    url: "https://www.yoocal.com/about",
    type: "website",
  },
};

export default function AboutYoocalPage() {
  return (
    <>
      <SiteNav activeKey="about" />
      ...
      <div className="hero">
        <div className="hero-content">
          ...
          <p>
            One place for everything happening in your city — for locals and
            visitors alike. Updated daily from every source that matters.
          </p>
        </div>
      </div>
      ...
      <div className="content">
        <div className="mission">
          ...
          <h2>
            Stop checking <em>seven</em> different sites.
          </h2>
          <p>
            We automatically gather events from every local source —
            newspapers, venue websites, chamber listings, and more — and put
            them all in one clean, free calendar. No accounts. No paywalls.
            Just what&apos;s happening near you.
          </p>
        </div>
        ...
        <div className="how-grid">
          <div className="how-card">
            ...
            <p>
              ...
              boards, local newspapers, venue sites, and more — so you
              don&apos;t have to.
            </p>
          </div>
          <div className="how-card">
            ...
            <p>
              ...
              Every event is organized so you can find what you&apos;re
          ...
          <div className="how-card">
            ...
            <p>
              ...
              businesses who want their events seen — not by ads or
              subscription fees.
            </p>
          </div>
        </div>
          ...
          <div className="cities-grid">
            ...
            <a href="/elkhart-lake" className="city-card">
              ...
              <div className="city-info">
                ...
                <p>
                  Racing, local events, and everything happening around Road
                  America and Sheboygan County.
                </p>
              </div>
              <span className="city-badge live">Live</span>
            </a>
        ...
        <div className="values">
          <div className="value">
            ...
            <p>
              ...
              feeds — every listing comes from a source that actually covers
              your community.
            </p>
          </div>
          <div className="value">
            ...
            <p>
              ...
              years or just drove into town, Yoocal is your guide.
            </p>
          </div>
          <div className="value">
            <div className="value-icon">📰</div>
            ...
            <p>
              ...
              driving traffic back to the outlets that cover your community.
            </p>
          </div>
          <div className="value">
            <div className="value-icon">💜</div>
            ...
            <p>
              ...
              smaller, charming places that deserve better discovery tools.
            </p>
          </div>
        </div>
        ...
        <div className="cta-banner">
          <h2>
            Find what&apos;s happening <em>near you.</em>
          </h2>
      ...
      <style>{`
        ...
        .content { max-width: 1100px; margin: 0 auto; padding: 80px 40px 120px; }
        ...
        .mission { text-align: center; max-width: 680px; margin: 0 auto 80px; }
        .mission h2 {
          font-family: 'DM Serif Display', serif;
          font-size: clamp(28px, 4vw, 44px);
          margin-bottom: 20px; line-height: 1.2;
        }
        .mission h2 em { font-style: italic; color: var(--purple); }
        .mission p { font-size: 17px; color: var(--muted); line-height: 1.8; }
        ...
        .cities-section { margin-bottom: 80px; }
        .cities-section h2 {
          font-family: 'DM Serif Display', serif;
        ...
        .city-card.coming-soon { opacity: 0.5; cursor: default; }
        ...
        .city-badge.live { background: rgba(83,74,183,0.1); color: var(--purple); }
        .city-badge.soon { background: #f3f4f6; color: var(--muted); }
        ...
        .cta-banner h2 em { font-style: italic; color: #9b8ff0; }
        .cta-banner p {
