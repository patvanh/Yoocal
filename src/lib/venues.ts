...
export const VENUES_BY_CITY: Record<"parkcity" | "elkhartlake" | "heber" | "jackson", Venue[]> = {
  parkcity: [
    ...
    },
    {
      ...
      matchAliases: ["625 Main Street", "625 Main St"],
    },
    {
      name: "Red Barn",
      emoji: "🎵",
      ...
      matchAliases: ["4300 UT-32", "4300 UT 32"],
    },
    {
      ...
      matchAliases: ["3925 E. Snowbasin Rd", "3925 E Snowbasin Rd"],
    },
    {
      ...
      matchAliases: ["4949 Woodenshoe Lane", "Woodenshoe"],
    },
    {
      ...
      matchAliases: ["7560 Royal Street", "7560 Royal St"],
    },
    {
  ...
  jackson: [
    {
      ...
      matchAliases: ["307 Dance Hall", "7705 Lupine Ln"],
    },
    {
